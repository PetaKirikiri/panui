...
export function AppSidebar() {
  ...
  return (
    <aside
      id="panui-sidebar"
      className="relative flex w-64 shrink-0 flex-col overflow-hidden border-r border-gray-200 bg-gray-50"
    >
      <nav
      ...
      >
        <p className="text-xs font-semibold uppercase tracking-wide text-gray-500">Harry Potter</p>
        ...
        <p className="mb-1 mt-4 text-xs font-semibold uppercase tracking-wide text-gray-500">Tools</p>
        <Link
          to="/import"
          className={
